...
# Define paths
odgt_file_path = '/Users/jeong-yungeol/Desktop/vertexai/annotation_val.odgt'
...
def display_labeled_image(image_path, label_data):
    ...
    for label in label_data['annotations']:
        ...
        # Put category text
        cv2.putText(image, str(category), (int(bbox[0]), int(bbox[1]) - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (255, 0, 0), 2)
